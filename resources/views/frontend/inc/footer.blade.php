...
<section class="bg-dark py-5 text-light footer-widget footer-css">
    <div class="px-4">
        <div class="row">
            <div class="col-lg-4 col-xl-4 text-center text-md-left">
                <div class="mt-4">
                    <a href="{{ route('home') }}" class="d-block">
                        ...
                        <img class="lazyload" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" data-src="{{ uploaded_asset(get_setting('footer_logo')) }}" alt="{{ env('APP_NAME') }}" height="200">
                        @else
                        <img class="lazyload" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" data-src="{{ static_asset('assets/img/logo.png') }}" alt="{{ env('APP_NAME') }}" height="200">
                        @endif
                    </a>
                    <!--<div class="my-3">-->
                    ...
                    <div class="d-inline-block d-md-block mb-4">
                        <form class="form-inline" method="POST" action="{{ route('subscribers.store') }}">
                            ...
                            <div class="form-group mb-0">
                                <input style="border-radius: .25rem 0 0 .25rem" type="email" class="form-control" placeholder="{{ translate('Your Email Address') }}" name="email" required>
                            </div>
                            <button style="border-radius: 0 .25rem .25rem 0" type="submit" class="btn btn-primary">
                                {{ translate('Subscribe') }}
                            </button>
                        </form>
                    </div>
...
@endif-->
            ...
            <div class="col-lg-2 ml-xl-auto col-md-4 mr-0">
                <div class="text-center text-md-left mt-4">
                    ...
                    <div class="list-unstyled d-grid gap-2 social">
  @if (get_setting('facebook_link') != null)
    <a
      href="{{ get_setting('facebook_link') }}"
      target="_blank"
      class="facebook"
      ><i class="lab la-facebook-f"></i> {{ translate('Facebook') }}</a
    >
  @endif @if (get_setting('twitter_link') != null)
    <a
    ...
    > {{ translate('Twitter') }}</a>
  @endif @if (get_setting('instagram_link') != null)
    <a
      href="{{ get_setting('instagram_link') }}"
      target="_blank"
      class="instagram"
      ><i class="lab la-instagram"></i
    >{{ translate('Instagram') }}</a>
  @endif @if (get_setting('youtube_link') != null)
    <a
    ...
    >{{ translate('Youtube') }}</a>
  @endif @if (get_setting('linkedin_link') != null)
    <a
      href="{{ get_setting('linkedin_link') }}"
      target="_blank"
      class="linkedin"
      ><i class="lab la-linkedin-in"></i
    >{{ translate('Linkedin') }}</a>
  @endif
</div>
                ...
                <div class="text-center text-md-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            ...
                            <span class="d-block opacity-100 hov-opacity-50">{{ get_setting('contact_address', null, App::getLocale()) }}</span>
                        </li>
                        <li class="mb-2">
                            <!--<span class="d-block opacity-30">{{ translate('Phone') }}:</span>-->
                            <a aria-label="Chat on WhatsApp" target="_blank" href="https://wa.me/7419001709" class="text-white d-block">
                                <img src="{{ static_asset('assets/img/whatsapp.png') }}" width="30"/>
                                {{ get_setting('contact_phone') }} </a>
                        </li>
                        <li class="mb-2">
                            <!--<span class="d-block opacity-30">{{ translate('Email') }}:</span>-->
                            <span class="d-block opacity-">
                                <a href="mailto:{{ get_setting('contact_email') }}" class="text-reset">
                                    <svg style="background: white;border-radius: 50px;padding: 3px;" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 48 48">
            ...
            <div class="col-lg-2 col-md-4">
                <div class="text-center text-md-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2">
                            <a href="{{ json_decode(get_setting('widget_one_links'), true)[$key] }}" class="opacity-100 hov-opacity-50 text-reset">
                                {{ $value }}
                            </a>
                        </li>
                        @endforeach
            ...
            <div class="col-md-2 col-lg-2">
                <div class="text-center text-md-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        @if (Auth::check())
                        <li class="mb-2">
                            <a class="opacity-100 hov-opacity-50 text-reset" href="{{ route('logout') }}">
                                {{ translate('Logout') }}
                            </a>
                        </li>
                        @else
                        <li class="mb-2">
                            <a class="opacity-100 hov-opacity-50 text-reset" href="{{ route('user.login') }}">
                                {{ translate('Login') }}
                            </a>
                        </li>
                        @endif
                        <li class="mb-2">
                            <a class="opacity-100 hov-opacity-50 text-reset" href="{{ route('purchase_history.index') }}">
                                {{ translate('Order History') }}
                            </a>
                        </li>
                        <li class="mb-2">
                            <a class="opacity-100 hov-opacity-50 text-reset" href="{{ route('wishlists.index') }}">
                                {{ translate('My Wishlist') }}
                            </a>
                        </li>
                        <li class="mb-2">
                            <a class="opacity-100 hov-opacity-50 text-reset" href="{{ route('orders.track') }}">
                        ...
                        <li class="mb-2">
                            <a class="opacity-100 hov-opacity-50 text-light" href="{{ route('affiliate.apply') }}">{{ translate('Be an affiliate partner') }}</a>
                        </li>
                        @endif
                    </ul>
                </div>
                ...
                <div class="text-center text-md-left mt-4">
                    ...
                    <div id="siteseal" class="mt-3">
                        <script async type="text/javascript" src="https://seal.godaddy.com/getSeal?sealID=BKDoxFUIKR3qqhMev2LC7dQR5JPBinv73syK7VlqK4Q5nj9BmSq9s0gKdNaJ"></script>
                    </div>
                </div>
                @endif
            </div>
        ...
        <div class="row align-items-center">
            <div class="col-lg-4">
                <div class="text-center text-md-left" current-verison="{{ get_setting('current_version') }}">
                    ...
                    <a style="position: fixed;bottom: 40px;left: 20px;z-index: 9999;" 
                    aria-label="Chat on WhatsApp" target="_blank" href="https://wa.me/7419001709"><img src="{{ static_asset('assets/img/whatsapp.png') }}" width="35"/></a>
