                        ...
                        @else
                            ...
                            <li class="list-inline-item mr-3 border-right border-left-0 pr-3 pl-0">
                                <a href="{{ route('dashboard') }}"
                                    class="text-reset d-inline-block opacity-80">{{ translate('My
                                                                                                                                                                            Panel') }}</a>
                            </li>
                        @endif
...
@endif
    ...
    @if (get_setting('header_menu_labels') != null)
        <div class="bg-white border-top border-gray-200 pt-3 pb-2">
            <div class="container-fluid">
                <div class="d-flex1">
                    <ul class="list-inline d-flex align-items-center text-right mb-0 pl-0 mobile-hor-swipe">
                            ...
                            <a class="py-20px mr-3 ml-0" href="{{ route('home') }}">
                                ...
                                @if ($header_logo != null)
                                    <img src="{{ uploaded_asset($header_logo) }}" alt="{{ env('APP_NAME') }}"
                                        class="mw-100 h-40px h-md-70px" height="70">
                                @else
                        ...
                        @foreach (json_decode(get_setting('header_menu_labels'), true) as $key => $value)
                            <li class="list-inline-item mr-0">
                                <a href="{{ json_decode(get_setting('header_menu_links'), true)[$key] }}"
                                    class="fs-14 px-2 py-2 d-inline-block fw-600 hov-opacity-70 text-reset">
                                    {{ translate($value) }}
                                </a>
                            </li>
                        @endforeach
                        ...
                        <div class="p-2 d-block text-reset" data-toggle="class-toggle" data-target=".front-header-search">
                            <i class="las la-search la-flip-horizontal la-2x"></i>
                        </div>
                    </div>
    
                    <div class="show-input-non front-header-search">
