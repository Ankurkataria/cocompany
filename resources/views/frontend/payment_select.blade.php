    ...
    <section class="mb-4">
        <div class="container text-left">
            <div class="row">
                                    ...
                                    <div class="col-xxl-8 col-xl-10 mx-auto">
                                        <div class="row gutters-10">
                                                    ...
                                                    <label class="aiz-megabox d-block mb-3">
                                                        ...
                                                        <span class="d-block p-3 aiz-megabox-elem">
                                                            ...
                                                            <span class="d-block text-center">
                                                                <span
                                                                    class="d-block fw-800 fs-12">{{ translate('Paypal') }}</span>
                                                            </span>
                                                        </span>
                                                    </label>
                                                </div>
                                                ...
                                                <div class="col-6 col-md-4">
                                                    <label class="aiz-megabox d-block mb-3">
                                                        ...
                                                        <span class="d-block p-3 aiz-megabox-elem">
                                                            ...
                                                            <span class="d-block text-center">
                                                                <span
                                                                    class="d-block fw-800 fs-12">{{ translate('Stripe') }}</span>
                                                            </span>
                                                        </span>
                                                    </label>
                                                </div>
                                                ...
                                                <div class="col-6 col-md-4">
                                                    <label class="aiz-megabox d-block mb-3">
                                                        ...
                                                        <span class="d-block p-3 aiz-megabox-elem">
                                                            ...
                                                            <span class="d-block text-center">
                                                                <span
                                                                    class="d-block fw-800 fs-12">{{ translate('sslcommerz') }}</span>
                                                            </span>
                                                        </span>
                                                    </label>
                                                </div>
                                                ...
                                                <div class="col-6 col-md-4">
                                                    <label class="aiz-megabox d-block mb-3">
                                                        ...
                                                        <span class="d-block p-3 aiz-megabox-elem">
                                                            ...
                                                            <span class="d-block text-center">
                                                                <span
                                                                    class="d-block fw-800 fs-12">{{ translate('Instamojo') }}</span>
                                                            </span>
                                                        </span>
                                                    </label>
                                                </div>
                                                ...
                                                <div class="col-6 col-md-4">
                                                    <label class="aiz-megabox d-block mb-3">
                                                        ...
                                                        <span class="d-block p-3 aiz-megabox-elem">
                                                            ...
                                                            <span class="d-block text-center">
                                                                <span
                                                                    class="d-block fw-800 fs-12">{{ translate('Razorpay') }}</span>
                                                            </span>
                                                        </span>
                                                    </label>
                                                </div>
                                                ...
                                                <div class="col-6 col-md-4">
                                                    <label class="aiz-megabox d-block mb-3">
                                                        ...
                                                        <span class="d-block p-3 aiz-megabox-elem">
                                                            ...
                                                            <span class="d-block text-center">
                                                                <span
                                                                    class="d-block fw-800 fs-12">{{ translate('Paystack') }}</span>
                                                            </span>
                                                        </span>
                                                    </label>
                                                </div>
                                                ...
                                                <div class="col-6 col-md-4">
                                                    <label class="aiz-megabox d-block mb-3">
                                                        ...
                                                        <span class="d-block p-3 aiz-megabox-elem">
                                                            ...
                                                            <span class="d-block text-center">
                                                                <span
                                                                    class="d-block fw-800 fs-12">{{ translate('VoguePay') }}</span>
                                                            </span>
                                                        </span>
                                                    </label>
                                                </div>
                                                ...
                                                <div class="col-6 col-md-4">
                                                    <label class="aiz-megabox d-block mb-3">
                                                        ...
                                                        <span class="d-block p-3 aiz-megabox-elem">
                                                            ...
                                                            <span class="d-block text-center">
                                                                <span
                                                                    class="d-block fw-800 fs-12">{{ translate('payhere') }}</span>
                                                            </span>
                                                        </span>
                                                    </label>
                                                </div>
                                                ...
                                                <div class="col-6 col-md-4">
                                                    <label class="aiz-megabox d-block mb-3">
                                                        ...
                                                        <span class="d-block p-3 aiz-megabox-elem">
                                                            ...
                                                            <span class="d-block text-center">
                                                                <span
                                                                    class="d-block fw-800 fs-12">{{ translate('ngenius') }}</span>
                                                            </span>
                                                        </span>
                                                    </label>
                                                </div>
                                                ...
                                                <div class="col-6 col-md-4">
                                                    <label class="aiz-megabox d-block mb-3">
                                                        ...
                                                        <span class="d-block p-3 aiz-megabox-elem">
                                                            ...
                                                            <span class="d-block text-center">
                                                                <span
                                                                    class="d-block fw-800 fs-12">{{ translate('Iyzico') }}</span>
                                                            </span>
                                                        </span>
                                                    </label>
                                                </div>
                                                ...
                                                <div class="col-6 col-md-4">
                                                    <label class="aiz-megabox d-block mb-3">
                                                        ...
                                                        <span class="d-block p-3 aiz-megabox-elem">
                                                            ...
                                                            <span class="d-block text-center">
                                                                <span
                                                                    class="d-block fw-800 fs-12">{{ translate('Nagad') }}</span>
                                                            </span>
                                                        </span>
                                                    </label>
                                                </div>
                                                ...
                                                <div class="col-6 col-md-4">
                                                    <label class="aiz-megabox d-block mb-3">
                                                        ...
                                                        <span class="d-block p-3 aiz-megabox-elem">
                                                            ...
                                                            <span class="d-block text-center">
                                                                <span
                                                                    class="d-block fw-800 fs-12">{{ translate('Bkash') }}</span>
                                                            </span>
                                                        </span>
                                                    </label>
                                                </div>
                                                ...
                                                <div class="col-6 col-md-4">
                                                    <label class="aiz-megabox d-block mb-3">
                                                        ...
                                                        <span class="d-block p-3 aiz-megabox-elem">
                                                            ...
                                                            <span class="d-block text-center">
                                                                <span
                                                                    class="d-block fw-800 fs-12">{{ translate('Aamarpay') }}</span>
                                                            </span>
                                                        </span>
                                                    </label>
                                                </div>
                                                ...
                                                <div class="col-6 col-md-4">
                                                    <label class="aiz-megabox d-block mb-3">
                                                        ...
                                                        <span class="d-block p-3 aiz-megabox-elem">
                                                            ...
                                                            <span class="d-block text-center">
                                                                <span
                                                                    class="d-block fw-800 fs-12">{{ translate('ProxyPay') }}</span>
                                                            </span>
                                                        </span>
                                                    </label>
                                                </div>
                                                    ...
                                                    <div class="col-6 col-md-4">
                                                        <label class="aiz-megabox d-block mb-3">
                                                            ...
                                                            <span class="d-block p-3 aiz-megabox-elem">
                                                                ...
                                                                <span class="d-block text-center">
                                                                    <span
                                                                        class="d-block fw-800 fs-12">{{ translate('mpesa') }}</span>
                                                                </span>
                                                            </span>
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="col-6 col-md-4">
                                                        <label class="aiz-megabox d-block mb-3">
                                                            ...
                                                            <span class="d-block p-3 aiz-megabox-elem">
                                                                ...
                                                                <span class="d-block text-center">
                                                                    <span
                                                                        class="d-block fw-800 fs-12">{{ translate('flutterwave') }}</span>
                                                                </span>
                                                            </span>
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="col-6 col-md-4">
                                                        <label class="aiz-megabox d-block mb-3">
                                                            ...
                                                            <span class="d-block p-3 aiz-megabox-elem">
                                                                ...
                                                                <span class="d-block text-center">
                                                                    <span
                                                                        class="d-block fw-800 fs-12">{{ translate('payfast') }}</span>
                                                                </span>
                                                            </span>
                                                        </label>
                                                    </div>
                                            ...
                                            <div class="col-6 col-md-4">
                                                <label class="aiz-megabox d-block mb-3">
                                                    ...
                                                    <span class="d-block p-3 aiz-megabox-elem">
                                                        ...
                                                        <span class="d-block text-center">
                                                            <span
                                                                class="d-block fw-800 fs-12">{{ translate('Paytm') }}</span>
                                                        </span>
                                                    </span>
                                                </label>
                                            </div>
                                            ...
                                            @if (get_setting('cash_payment') == 1)
                                                ...
                                                @endphp
                                                @if (299 <= $total && $total <= 1999 && $digital != 1 && $cod_on == 1)
                                                    <div class="col-6 col-md-4">
                                                        <label class="aiz-megabox d-block mb-3">
                                                            ...
                                                            <span class="d-block p-3 aiz-megabox-elem">
                                                                ...
                                                                <span class="d-block text-center">
                                                                    <span
                                                                        class="d-block fw-800 fs-12">{{ translate('Cash on Delivery') }}</span>
                                                                </span>
                                                            </span>
                                                        </label>
                                                    </div>
                                                        ...
                                                        <div class="col-6 col-md-4">
                                                            <label class="aiz-megabox d-block mb-3">
                                                                ...
                                                                <span class="d-block p-3 aiz-megabox-elem">
                                                                    ...
                                                                    <span class="d-block text-center">
                                                                        <span
                                                                            class="d-block fw-800 fs-12">{{ $method->heading }}</span>
                                                                    </span>
                                                                </span>
                                                            </label>
                                                        </div>
                ...
                <div class="col-lg-5 mt-4 mt-lg-0" id="cart_summary">
