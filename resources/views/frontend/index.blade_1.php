                                ...
                                <div class="container-fluid">
                                    <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                                        <div class="d-flex mb-3 align-items-baseline border-bottom">
                                            ...
                                            <div class="col-md-6 text-center">
                                                <h3 class="h5 fw-900 text-uppercase mb-0">
                                                    <span
                                                        class="border-bottom fs-24 border-primary border-width-2 pb-3 d-inline-block">NEW
                                                        LAUNCHES
                                                    </span>
                                                </h3>
                                            </div>
                                        ...
                                        <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="6"
                                            data-xl-items="3" data-lg-items="3" data-md-items="3" data-sm-items="2"
                                            data-xs-items="2" data-arrows='false'>
            ...
            <div class="px-2 px-md-4 py-5 bg-white shadow-sm rounded">
                <div class="row gutters-10">
                    ...
                    @php
                        ...
                        $array = ['Hair', 'Face', 'Body', 'Combo'];
                        $slug = ['Hair-LQoRz', 'Face-C4Qdc', 'Body-EkmfL', 'Combo-QNvTc'];
                    @endphp
                        ...
                        <div class="col-xl col-md-6">
                            <a href="{{ route('products.category', $slug[$k]) }}">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div style="border-radius: 0 50rem 50rem 0"
                                        class="w-100 shadow ml-n3 z-0 text-center bg-light px-3 py-2">
                                        {{-- <h2 class="mb-0 fw-bolder">Solution For</h2> --}}
                                        <h3 class="h5 fw-700 mb-0">
                                            Solution For
                                        </h3>
                                        <h6 class="mb-0 text-danger fw-700">{{ $array[$k] }}</h6>
                                    </div>
                                </div>
                            </a>
                        </div>
