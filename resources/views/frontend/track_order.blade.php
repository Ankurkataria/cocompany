...
@php
    ...
    {
        $orderId = request()->get('order_code');
    }
@endphp
@section('content')
...
<section class="mb-5">
    <div class="container text-left">
                    ...
                    <div class="bg-white rounded shadow-sm">
                        ...
                        <div class="form-box-content p-3">
                            <div class="form-group">
                                <input type="text" class="form-control mb-3" placeholder="{{ translate('Order Code')}}" name="order_code" required value="{{$orderId}}">
                            </div>
        ...
        @else
            @if(request()->has('order_code'))
                <div class="fs-15 fw-600 p-3 border-bottom text-center alert alert-danger" role="alert">
                    <p>{{ translate(sprintf('%s order code is not matched with our records, please verify your order details.', request()->get('order_code')))}}</p>
                </div>
            @endif    
        @endif
    </div>
