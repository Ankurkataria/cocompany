        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th class="product-total text-right">{{ translate('Unit Price') }}</th>
                       <th class="product-total text-right">{{ translate('Discount') }}</th>
            ...
            <tbody>
                ...
                @foreach ($carts as $key => $cartItem)
                    ...
                    <tr class="cart_item">
                        ...
                        <td>
                            <span
                                class="pl-4 pr-0">{{ single_price($cartItem['unit_price'] * $cartItem['quantity']) }}</span>
                        </td>
                        <td>
                            <span class="pl-4 pr-0">
                                @if ($cartItem['discount_type'] === 'percent')
                                    {{ $cartItem['price_discount'] }}%
                                @elseif ($cartItem['discount_type'] === 'amount')
                                    &#8377; {{ $cartItem['price_discount'] }}
                                @endif
                            </span>
                        </td>
