                ...
                <table class="table aiz-table mb-0">
                    <thead>
                        <tr>
                            ...
                            <th data-breakpoints="md">{{ translate('Write Review')}}</th>
                        ...
                        @foreach ($orders as $key => $order)
                            @if (count($order->orderDetails) > 0)
                                <tr>
                                    ...
                                    <td>
                                        @if($order->is_reviewed == '0')
                                            <a href="javascript:void(0)"  class="btn btn-soft-info btn-icon btn-circle btn-sm" onclick="show_write_review_modal ({{ $order->id }})" title="{{ translate('Write Review') }}">
                                            <i class="las la-pencil-alt"></i>
                                            </a>
                                        @else 
                                            <a href="javascript:void(0)"  class="btn btn-soft-info btn-icon btn-circle btn-sm disabled"                 onclick="show_write_review_modal ({{ $order->id }})" title="{{ translate('You have already reviewd it') }}">
                                                <i class="las la-pencil-alt"></i>
                                            </a>
                                        @endif
