                    ...
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" name="PROXYPAY_TOKEN"
                                        value="{{ env('PROXYPAY_TOKEN') }}"
                                        placeholder="{{ translate('PROXYPAY TOKEN') }}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" name="PROXYPAY_ENTITY"
                                        ...
                                        placeholder="{{ translate('PROXYPAY_ENTITY') }}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="PROXYPAY_END_TIME"
                                            value="{{ env('PROXYPAY_END_TIME') }}"
                                            placeholder="{{ translate('PROXYPAY_END_TIME') }}" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input value="1" name="proxypay_sandbox" type="checkbox"
                                            @if (get_setting('proxypay_sandbox') == 1) checked @endif>
                                        <span class="slider round"></span>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="PAYTM_MERCHANT_ID"
                                        ...
                                        placeholder="{{ translate('PAYTM MERCHANT ID') }}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="PAYTM_MERCHANT_KEY"
                                        ...
                                        placeholder="{{ translate('PAYTM MERCHANT KEY') }}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="PAYTM_MERCHANT_WEBSITE"
                                        ...
                                        placeholder="{{ translate('PAYTM MERCHANT WEBSITE') }}" required>
                                </div>
                            </div>
                            <div class="form-group mb-0 text-right">
                                <button type="submit" class="btn btn-sm btn-primary">{{ translate('Save') }}</button>
