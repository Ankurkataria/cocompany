...
Route::group(['middleware' => ['user', 'verified', 'unbanned']], function () {
    ...
    Route::post('/customer_write_review', 'PurchaseHistoryController@customer_write_review_purchase_details')->name('customer.write_review');
    Route::post('/customer_write_review_save', 'PurchaseHistoryController@customer_write_review_store')->name('customer.write_review_store');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('/orders/return-order/{id}', 'OrderController@return_order')->name('orders.return_order');
...
//paytm route
Route::post('paytm-callback', 'PaytmController@paytmCallback')->name('paytm.callback');
